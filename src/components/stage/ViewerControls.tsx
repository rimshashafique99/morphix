      ...
      <div className="flex h-[47px] items-center gap-5 rounded-[12px] border border-line bg-white px-5 py-2 shadow-[4px_7px_4px_rgba(0,0,0,0.03),1px_2px_2px_rgba(0,0,0,0.03)]">
        <div className="flex w-28 items-center justify-between">
          <button
            ...
            onClick={onZoomOut}
            aria-label="Zoom out"
            className="text-muted-500 transition-colors hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
        ...
        <div className="flex items-center border-l border-line pl-4">
          <button
            ...
            className="flex size-6 items-center justify-center text-muted-500 transition-colors hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
